...
* Got to the terminal window where you lanched workshop setup
...
== Merge newly created cluster information into an existing web-app.
[source,shell]
----
./upload-instance-details.sh 1.2.3.4
----
