...
CREATE DATABASE "db-das" OWNER ecs ENCODING 'UTF8';
CREATE DATABASE "db-hue" OWNER ecs ENCODING 'UTF8';
CREATE DATABASE "db-cadence" OWNER ecs ENCODING 'UTF8';
CREATE DATABASE "db-cadence-visibility" OWNER ecs ENCODING 'UTF8';
