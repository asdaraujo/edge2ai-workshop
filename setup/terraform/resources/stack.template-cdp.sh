...
CDH_PARCEL_REPO=${CM_BASE_URL}/cdh${CDH_MAJOR_VERSION}/${CDH_VERSION}.0/parcels/
...
CEM_BASE_URL=${CM_BASE_URL}/CEM/centos7/${CEM_MAJOR_VERSION}.x/updates/${CEM_VERSION}
CEM_TARBALL=CEM-${CEM_VERSION}-centos7-tars-tarball.tar.gz
CEM_URL=${CEM_BASE_URL}/CEM-${CEM_VERSION}-centos7-tars-tarball.tar.gz
