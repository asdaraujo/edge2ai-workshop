...
We have now taken data from one topic, calculated aggregated results and written these to another topic. And to validate this was successful we have selected the result with an independent select query.
