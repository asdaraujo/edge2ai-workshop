...
+
The following configuration enables that replication. Connect to *Cluster A* and run the following commands:
+
[source]
----
export security_protocol=PLAINTEXT
...
----
+
Run the following command to confirm that the whitelists were correctly modified:
+
[source]
----
sudo -E srm-control topics \
